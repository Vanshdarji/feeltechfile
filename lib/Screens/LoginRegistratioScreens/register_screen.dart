            ...
            key: _formkey,
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintText: "Enter Name",hintStyle: TextStyle(color: Color(0xffb0b6ba),fontSize: 14)),
                ),
              ),
              Padding(
                padding: EdgeInsets.only(bottom: 10),
              ...
              InkWell(
                ...
                child: Row(
                    children: [
                      ...
                      RichText(
                        overflow: TextOverflow.ellipsis,
                        text: TextSpan(text: 'I Read and aagree to ',
                      style: TextStyle(fontSize: 12,fontWeight: FontWeight.w400,color: Colors.white),
                      children: [TextSpan(text: 'Terms & Conditions',style: TextStyle(color: Color(0xffea6752),fontWeight: FontWeight.w400,fontSize: 12 ))]),
                      )
                    ]),
              ),
                    5.heightBox,
              ...
              TextButton(
                  ...
                  child: Text(
                    "Login",
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(color: Color(0xff8f3edf),fontSize: 14,fontWeight: FontWeight.w500),
                  ))
                              ])
                            ]),
            )
