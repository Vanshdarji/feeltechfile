          ...
          child: Container(
            child: Column(
              children: [
                  ...
                  child: Container(
                    ...
                    child: EasyDateTimeLine(
                      ...
                      dayProps: const EasyDayProps(
                        inactiveMothStrStyle: TextStyle(color: Colors.white),
                        height: 55,
                        width: 50,
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                colors: box8
                                    ...
                                    : [Color(0xff1f203c), Color(0xff1f203c)],
                              ),
                              borderRadius:
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            color: _seats[row][col] ? Color(0xff1f203c) : Colors.white,
                ...
                Center(
                  child: Text("SEAT NO: F6, F7, F8",style: TextStyle(color: Colors.white,fontSize: 12,fontWeight: FontWeight.w500),),
                ),
                20.heightBox,
                Center(
                  child: Container(
